...
namespace M2E\M2ECloudMagentoConnector\Model\Magento\Quote\Total;

use M2E\M2ECloudMagentoConnector\Model\Magento\Tax\Rule\Builder as TaxRuleBuilder;
use Magento\Tax\Model\Sales\Total\Quote\CommonTaxCollector;

class RoundTaxPercent extends \Magento\Quote\Model\Quote\Address\Total\AbstractTotal
{
    public const PRODUCT_PRICE_TAX_DATA_KEY = 'm2e_m2ecloud_product_price_tax';
    public const SHIPPING_PRICE_TAX_DATA_KEY = 'm2e_m2ecloud_shipping_price_tax';
    ...
    public function collect(
        ...
        /** @var \M2E\M2ECloudMagentoConnector\Model\Order\Tax\PriceTaxRateInterface $productPriceTaxRate */
        ...
        /** @var \M2E\M2ECloudMagentoConnector\Model\Order\Tax\PriceTaxRateInterface $shippingPriceTaxRate */
    ...
    private function processForPriceTax(
        string $ruleCode,
        \Magento\Quote\Model\Quote\Address\Total $total,
        \M2E\M2ECloudMagentoConnector\Model\Order\Tax\PriceTaxRateInterface $taxRate
    ): void {
     ...
     * @param \M2E\M2ECloudMagentoConnector\Model\Order\Tax\PriceTaxRateInterface $taxRate
     *
     * @return float|int
     */
    private function replaceTaxPercent($inputPercent, \M2E\M2ECloudMagentoConnector\Model\Order\Tax\PriceTaxRateInterface $taxRate)
    {
